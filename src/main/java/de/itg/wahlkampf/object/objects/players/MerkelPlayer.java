...
public class MerkelPlayer extends AbstractPlayerObject {
    ...
    public MerkelPlayer(int id) {
        super("Merkel", Map.of("stand", new PlayerImage("assets/character/Merkel.png"), "hit", new PlayerImage("assets/character/animation/merkel_hit_edited.png")), id, 200,5, 50, 180, 50, 21, 53);
