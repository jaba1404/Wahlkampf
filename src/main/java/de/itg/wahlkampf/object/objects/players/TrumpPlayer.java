...
public class TrumpPlayer extends AbstractPlayerObject {
    ...
    public TrumpPlayer(int id, int positionX, int positionY) {
        super("Trump", Map.of("stand", new PlayerImage("assets/character/Trump.png"), "hit", new PlayerImage("assets/character/animation/trump_hit_edited.png")), id, 100, 8, 30, positionX, positionY, 21, 53);
